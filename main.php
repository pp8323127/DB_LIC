...
<table width="100%" border="0" align="center">
  ...
  <tr class="a2">
    ...
    <td height="10" bgcolor="#999999" class="a1">會員中心</td>
    <td height="1" bgcolor="#999999">&nbsp;</td>
  </tr>
</table>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="19%"><table width="100%" border="0" align="center">
      <tr>
        <td align="center" valign="middle"><input name="button4" type="submit" class="a11" id="button4" onclick="location.href=&quot;history.php&quot;" value="借閱歷史" /></td>
        <td align="center" valign="middle"><input name="button3" type="submit" class="a11" id="button2" onclick="location.href=&quot;member_update.php&quot;" value="修改資料" /></td>
...
<table width="100%" border="0" align="center">
  <tr>
    <td align="center"><span class="ccenter">基本資料：</span></td>
  </tr>
</table>
<table border="1" align="center" cellpadding="1" cellspacing="1" class="a1">
  <tr>
    <th width="45" align="center" valign="middle" scope="col">帳號</th>
    <th width="63" align="center" valign="middle" scope="col">姓名</th>
    <th width="82" align="center" valign="middle" scope="col">密碼</th>
    <th width="85" align="center" valign="middle" scope="col">班級</th>
    <th width="70" align="center" valign="middle" scope="col">性別</th>
    <th width="106" align="center" valign="middle" scope="col">E-mail</th>
    <th width="95" align="center" valign="middle" scope="col">連絡電話</th>
  </tr>
...
<?php
	//查詢自己借閱中的書
	$query2 = "SELECT * from list where id = '$id' && return_time = '0000-00-00 00:00:00';";
